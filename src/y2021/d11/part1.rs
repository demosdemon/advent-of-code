/*
    ...
    You enter a large cavern full of rare bioluminescent dumbo octopuses! They seem to
    ...
    octopus has an energy level of 5, the bottom-right one has an energy level of 6, and
    so on.
    ...
    Given the starting energy levels of the dumbo octopuses in your cavern, simulate 100
