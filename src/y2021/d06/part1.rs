/*
    ...
    another might have 4. So, you can model each fish as a single number that represents
    ...
    an internal timer of 4, and so on until the fifth fish, which has an internal timer
    of 2. Simulating these fish over several days would proceed as follows:
