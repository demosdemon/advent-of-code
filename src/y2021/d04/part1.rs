/*
    ...
    but the boards are marked as follows (shown here adjacent to each other to save
    space):
    ...
    column of marked numbers (in this case, the entire top row is marked: 14 21 17 24
    4).
