/*
    ...
    their sub-packets. If they only have a single sub-packet, their value is the value
    of the sub-packet.
    ...
    the first sub-packet is greater than the value of the second sub-packet; otherwise,
    ...
    Using these rules, you can now work out the value of the outermost packet in your
    BITS transmission.
