/*
    ...
    end up overlapping after the fold is complete, but dots will never appear exactly on
    a fold line. The result of doing this fold looks like this:
    ...
    in the result (at 0,3) remains visible, as it can be seen through the transparent
    paper.
